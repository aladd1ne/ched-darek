...
import { IPaginiation, Pagination } from '../shared/models/pagination';
...
export class ShopService {
  ...
  getProducts(useCache: boolean) {
    ...
    return this.http.get<IPaginiation>(this.baseUrl + 'products', { observe: 'response', params })
      .pipe(
        map(response => {
